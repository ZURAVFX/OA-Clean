...
logo = raster_svg(ASSETS / "oa-full-white.svg", 145)
...
icon = Image.open(ASSETS / "app-icon.png").convert("RGBA").resize((250, 250), Image.Resampling.LANCZOS)
canvas.paste(icon, (855, 190), icon)
